        ...
        {isFetching ? (
          ...
          <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
            ...
            <div className="w-full flex flex-wrap md:flex-row gap-2 items-center justify-between my-10">
              ...
              <div className="bg-[#acd6ec] w-40 h-16 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#e38bbf] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center">
              ...
              <div className="bg-[#dcb0ca] w-40 h-16 px-6 rounded-lg flex flex-col items-center justify-center">
