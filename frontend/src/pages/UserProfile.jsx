                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    ...
                    <div className="w-full flex gap-2 text-sm">
                      <div className="w-1/2 bg-gray-200 hover:bg-gray-300 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                      ...
                      <div className="w-1/2 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow">
                        <label className="text-gray-600 text-sm mb-1">
                          Resume
                        </label>
                        <input
