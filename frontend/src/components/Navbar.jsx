  ...
  return (
    <div>
      <Menu as="div" className="inline-block text-left">
        ...
        >
          <Menu.Items className="absolute z-50 right-2 mt-2 w-56 origin-bottom-right divide-y dividfe-gray-100 rounded-md bg-white showdow-lg focus:outline-none">
            <div className="p-1">
              <Menu.Item>
                {({ active }) => (
                  <Link
  ...
  return (
    <>
      <div className="relative  bg-white">
        <nav className="container mx-auto flex items-center justify-between p-5">
          <div>
            <Link to="/" className="text-blue-600 font-bold text-4xl">
              Job<span className="text-[#167cccb]">Sphere</span>
            </Link>
          </div>
        ...
        {/* MOBILE MENU */}
        <div
          className={`${isOpen ? "absolute flex bg-white " : "hidden"}
